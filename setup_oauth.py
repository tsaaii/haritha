...
def check_client_secrets():
    ...
    if not os.path.exists('client_secrets.json'):
        ...
        print("5. Add redirect URI: http://localhost:8050/oauth/callback")
    ...
    try:
        ...
        required_uri = 'http://localhost:8050/oauth/callback'
...
def main():
    ...
    print("2. Visit: http://localhost:8050/debug/oauth")
